...
unsigned int nTargetSpacing = 3 * 60; // OFWcoin - 180 second blocks
...
const string strMessageMagic = "OFWcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 4000000 * COIN; return nSubsidy; 
	}
    else if(pindexBest->nHeight < 26880)
	{
        nSubsidy = 100 * COIN;
    }
	else if(pindexBest->nHeight < 80640)
	{
        nSubsidy = 50 * COIN;
    }
	else if(pindexBest->nHeight > 80641)
	{
        nSubsidy = 40 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OFWcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "OFWcoin 7th July 2017";
        CTransaction txNew;
        txNew.nTime = 1499415775;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1499415775;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1389053;
		if(fTestNet)
        {
            block.nNonce = 1389053;
        }
		
		uint256 nhashMerkleRoot = uint256("0x950d2dfb2d19c49f2c0f00f27fe5078862b5b7262a088d7fea5d544f0d771fac");
